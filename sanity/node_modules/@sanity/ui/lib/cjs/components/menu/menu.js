...
const Root = (0, import_styled_components.default)(import_primitives.Box)`
  ...
  overflow: auto;
`;
const Menu = (0, import_react.forwardRef)((props, ref) => {
  const _a = props, {
    children,
    focusLast,
    onClickOutside,
  ...
  const [activeElement, setActiveElement] = (0, import_react.useState)(null);
  ...
  const handleKeyDown = (0, import_react.useCallback)((event) => {
    if (event.key === "ArrowUp") {
      ...
      const focusableElements = (0, import_helpers.getFocusableElements)(itemsRef.current);
