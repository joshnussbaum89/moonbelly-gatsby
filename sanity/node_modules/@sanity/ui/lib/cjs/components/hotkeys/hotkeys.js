...
const Root = import_styled_components.default.kbd`
  &:not([hidden]) {
    display: block;
  }
  font: inherit;
`;
const Key = (0, import_styled_components.default)(import_primitives.KBD)`
  &:not([hidden]) {
    display: block;
  }
`;
const Hotkeys = (0, import_react.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(Root, __spreadProps(__spreadValues({
    ...
    ref
  }), /* @__PURE__ */ import_react.default.createElement(import_primitives.Inline, {
    as: "span",
    space
  }, keys.map((key, i) => /* @__PURE__ */ import_react.default.createElement(Key, {
    fontSize: size,
    key: i,
    padding,
    radius
